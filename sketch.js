...
function draw() {
  ...
  if(keyDown("space")&& manBlock.isTouching(standBlockGroup)){
    man.velocityY=-3;
    manBlock.velocityY=-3;
    mainStand.destroy();
  }
  if(keyDown("space")&& manBlock.isTouching(mainStand)){
    man.velocityY=-3;
    manBlock.velocityY=-3;
    mainStand.destroy();                 
  }
  if(man.isTouching(mainStand)||manBlock.isTouching(standBlockGroup)){
    man.velocityY=0;
